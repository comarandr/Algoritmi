...
\begin{tabular}{|c |c| c |c |c|}
    ...
    \hyperlink{quicksort}{Quick Sort} & $\Theta(n^2)$ & $\Theta(n \log n)$ & & inplace \\
...
Ho un vettore da ordinare, scelgo un elemento che fa da perno e divido 
il vettore in due parti, uno contenente 
elementi minori del perno e uno con elementi maggiori.
